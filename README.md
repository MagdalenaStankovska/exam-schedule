...
2. При почеток на семестарот, администраторите креираат курсеви на кои доделуваат професори и ги креираат сесиите
3. Пред секоја сесија/колоквиум, професорите праќаат барања за форматот на испитите (дали се полагаат во лабораторија/просторија, колку траат, колку простории им требаат, други објаснувања/коментари)
4. Од студентска го изработуваат распоредот и праќаат можност за забелешки
5. По корекцијата на забелешките, се објавува распоредот 
...
```
cd existing_repo
git remote add origin https://gitlab.finki.ukim.mk/wp/exam-schedule.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.finki.ukim.mk/wp/exam-schedule/-/settings/integrations)
