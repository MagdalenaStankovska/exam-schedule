-- Safety migration for environments already baselined at version 1.
-- Re-applies required columns/tables using IF NOT EXISTS so it is safe to run repeatedly.
